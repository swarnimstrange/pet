...
import 'package:pet_skor/animal_info/Cat/cat_detail.dart';
...
class AllCats extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final cat = Provider.of<CatInfo>(context);
    return GestureDetector(
      onTap: () {
        Navigator.of(context).pushNamed(DetailCat.routeName, arguments: cat.id);
      },
      child: Card(
        shape:
